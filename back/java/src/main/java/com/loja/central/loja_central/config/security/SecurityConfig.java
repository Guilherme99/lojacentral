	...
	public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
		return httpSecurity.csrf(csrf -> csrf.disable())
				...
				.authorizeHttpRequests(authorize -> authorize
						...
						.requestMatchers(HttpMethod.POST, "/arquivos/**").permitAll()
						.requestMatchers(HttpMethod.GET, "/arquivos/**").permitAll()
						.requestMatchers(HttpMethod.PUT, "/arquivos/**").permitAll()
						.requestMatchers(HttpMethod.DELETE, "/arquivos/**").permitAll()
